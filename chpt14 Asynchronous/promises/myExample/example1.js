...
new Promise(function (resolve, reject) {
  ...
  */
  ...
  .then(
  (result) => console.log(" :) The room is " + result),   // rs
  (result) => console.log(" :( The room is " + result)    // rj
  )
  .catch(err => {  //global catch block is better: globally handling unhandled rejections
...
// 3. You should always tell it what to do on resolve and on reject (i.e., define rs and rj cb-functions)
//    Otherwise may produce a warning: UnhandledPromiseRejectionWarning when it indeed rejected.